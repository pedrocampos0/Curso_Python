...
Defaul Dict -> Ao criar um dicionário utilizando-o, nós informamos um valor default,
...
OBS: Lambdas são funções sem nome, que podem ou não receber parâmentros de entrada e retornar valores
...
print(dicionario['outro'])  # KeyError no dicionário ccomum, mas aqui não.
